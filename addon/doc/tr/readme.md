...
1. **NVDA+Shift+T**: Ön plandaki pencerenin durumunu seslendirir. Olası durumlar:
   ...
   - Sol üçte bir, orta üçte bir, sağ üçte bir (Windows 11 Snap Düzeni üçte birleri)
   - Sol üçte iki, sağ üçte iki (Windows 11 Snap Layout üçte iki)
...
- **Pencere durumuyla birlikte ekran numarasını bildir**: İşaretlendiğinde, pencere durumunun ardından ekran numarası gösterilir (örneğin, "geri yüklendi, 1 numaralı ekranda"). Birden fazla monitörle çalışırken kullanışlıdır. Varsayılan olarak kapalıdır.
