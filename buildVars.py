...
addon_info = AddonInfo(
	...
	addon_changelog=_("""Added detection of Windows 11 Snap Layout thirds (left, middle, and right thirds, plus the two-thirds combinations). Added an optional setting to report which display a window is on, matching JAWS behavior for multiple monitors."""),
	# Author(s)
